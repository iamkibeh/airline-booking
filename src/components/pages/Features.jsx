...
const AirlinesContainer = styled(Box)({
  backgroundColor: '#fff',
  width: '80%',
  margin: '0 auto',
  borderRadius: '10px',
...
const Features = () => {
  return (
    <>
        ...
        <Box display={'flex'} justifyContent={'center'}>
          ...
          >
            ...
            >
              ...
              <g>
                <path
                  id='uuid-54f431d9-8f52-4369-9c0b-5619dfe5d050-453'
                ...
                <g>
                  <path
                    id='uuid-b26c39a4-6f50-479a-8ec8-74191e458edf-454'
          ...
          >
            ...
            <Typography mt={2}>
              ...
              Praesentium ducimus blanditiis eaque debitis voluptates
              perspiciatis explicabo, ad magnam non obcaecati molestiae
              accusantium repellat, quam nam beatae vero, magni amet animi.
              Dolore eveniet vero aspernatur quo?
            </Typography>
          </Stack>
        </Box>
      </Box>
      ...
      <Box p={3} bgcolor='#c3cfe2'>
        <AirlinesContainer className='airline-container'>
          <Stack width={'60%'}>
          ...
          <img
            src={require('../../assets/pexels-mizuno-k-13431694-removebg-preview.png')}
